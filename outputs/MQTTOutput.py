...
class MWTTOutput(PluginLoader.Plugin):
        ...
        def process_message(self, msg):
                ...
                client.publish("power/solar/e_yesterday", msg.e_yesterday)
                client.publish("power/solar/e_this_month", msg.e_this_month)
                client.publish("power/solar/e_last_month", msg.e_last_month)
                ...
                for x in [1,2,3]:
                        ...
                        client.publish("power/solar/i_pv" + str(x), msg.i_pv(x))
