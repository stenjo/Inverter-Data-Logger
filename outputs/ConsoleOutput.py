...
class ConsoleOutput(PluginLoader.Plugin):
    ...
    def process_message(self, msg):
        ...
        p_tot = msg.v_pv(1)*msg.i_pv(1) + msg.v_pv(2)*msg.i_pv(2)

        sys.stdout.write('E Today     : {0:>5}    Yesterday: {1:>5}  Total: {2:<5}\n'.format(msg.e_today, msg.e_yesterday, ((((msg.e_today*10)-(int(msg.e_today*10)))/10)+msg.e_total)))
        sys.stdout.write('E This month: {0:>5}   Last month: {1:<5}\n'.format(msg.e_this_month, msg.e_last_month))
        sys.stdout.write('P Now       : {0:>5}         Temp: {1:<5}\n'.format(p_tot, msg.temperature))
