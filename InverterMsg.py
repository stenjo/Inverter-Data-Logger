...
#
    ...
    def id(self):
        """ID of the inverter."""
        return self.__get_string(15, 31).lstrip().rstrip() #Strip spaces from shorter or padded inverter SN
    ...
    def power(self):
        ...
        return (self.__get_short(33,1) * self.__get_short(39,1) + (self.__get_short(35,1)* self.__get_short(41,1)))/100
        #return self.__get_short(59,1)
    ...
    @property
    def e_yesterday(self):
        """Energy generated by inverter today in kWh"""
        return self.__get_short(67, 100)  # Divide by 100
    ...
    @property
    def e_this_month(self):
        """Total energy generated by inverter in kWh"""
        return self.__get_short(87, 1)

    @property
    def e_last_month(self):
        """Total energy generated by inverter in kWh"""
        return self.__get_short(91, 1)
